...
const Header = ({ session }: { session: Session }) => {
  ...
  return (
    <header
      className="fixed top-0 z-30 flex justify-between items-center px-6 py-3 bg-white/95 backdrop-blur-sm border-b border-gray-100/70 transition-all duration-300"
      style={{
